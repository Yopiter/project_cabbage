...
#define PUMP_TIME 5 //Zeit, in der die Pumpen arbeiten, wenn der boden trocken ist. //TODO: Testen und besseren Wert finden!!
...
void loop() {
  ...
  if (!handleTemperaturen(getTemperatur(DHTin), getTemperatur(DHTout))) {
    char Nachricht[] = "Zu kalt, aber auch schlecht durchlüftet!";
    Fehler(TEMP_HANDLING_ERROR, Nachricht);
  }
